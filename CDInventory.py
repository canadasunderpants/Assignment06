...
class FileProcessor:
    ...
    def write_file(file_name, table):
        """
        writes data entered by user to a text file for permanent storage
...
while True:
    ...
    # 3.3 process add a CD
        ...
        #DataProcessor.DataAdd(strID, strArtist, strTitle)
        continue  # start loop back at top.
    ...
    # 3.6 process save inventory to file
        ...
        if strYesNo == 'y':
            # 3.6.2.1 save data
            FileProcessor.write_file('CDInventory.txt', lstTbl)
        if strYesNo == 'n':    
